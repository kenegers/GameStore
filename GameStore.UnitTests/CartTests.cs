...
namespace GameStore.UnitTests
{
    ...
    public class CartTests
    {
        ...
        [TestMethod]
        ///пользователи имеют возможность менять свое решение и удалять товары из корзины
        ...
        [TestMethod]
        ///результате очистки корзины ее содержимое корректно удаляется
        ...
        public void Can_Add_To_Cart()
        {
            ...
            new Game {GameId = 1, Name = "Игра1", Category = "Кат1"}, }.AsQueryable());
        ...
        [TestMethod]
        ///позволяет проверить невозможность перехода к оплате при пустой корзине
